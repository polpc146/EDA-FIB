 ...
 */
#define PLAYER_NAME CataIanboy3
...
struct PLAYER_NAME : public Player {
  ...
  bool move_en_contra (Ant my_worker, Pos posicion, vector<vector<int>>& huecos_ocupados) {
      ...
      Cell movimiento;
              if (posicion.i < my_worker.pos.i){
                  ...
                  movimiento = cell(my_worker.pos.i +1, my_worker.pos.j);
                  if (movimiento.id == -1 and movimiento.type == Soil and my_worker.pos.i +1 >= 0 and my_worker.pos.i +1 < board_rows() and my_worker.pos.j >= 0 and my_worker.pos.j < board_cols()) {
                      
                      if(move_dir (my_worker, Down, huecos_ocupados)) return true;
                }
                movimiento = cell(my_worker.pos.i, my_worker.pos.j +1);
                  if (movimiento.id == -1 and movimiento.type == Soil and my_worker.pos.i >= 0 and my_worker.pos.i < board_rows() and my_worker.pos.j +1 >= 0 and my_worker.pos.j +1 < board_cols()) {
  ...
  Pos buscar_bonus (Ant my_worker) {
      ...
      queue<pair<pair<int,int>, Pos>> cola;
      visitados[my_worker.pos.i][my_worker.pos.j] = true;
      pair<pair<int,int>, Pos> encolar;
      for (int k = 0; k < 4; ++k) {
          
          int ii = my_worker.pos.i + di[k];
          int jj = my_worker.pos.j + dj[k];
          Cell casilla = cell(ii,jj);
          if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
              
              Pos posicion (ii,jj);
              if (casilla.bonus != None) return posicion;
              visitados[ii][jj] = true;
              encolar.first.first = ii;
              encolar.first.second = jj;
              encolar.second = posicion;
              cola.push(encolar);
          }
      }
      while (not cola.empty()) {
          
          auto i = cola.front().first.first;
          auto j = cola.front().first.second;
          auto p = cola.front().second;
          cola.pop();
          for (int k = 0; k < 4; ++k) {
              ...
              if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
                  ...
                  if (casilla.bonus != None) return p;
                  encolar.first.first = ii;
                  encolar.first.second = jj;
                  encolar.second = p;
                  cola.push(encolar);
  ...
  Pos buscar_mama (Ant my_worker, Ant mi_mama) {
      ...
      for (int k = 0; k < 4; ++k) {
          ...
          if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
              ...
              Pos posicion (ii,jj);
              if (casilla.id == mi_mama.id) return posicion;
              visitados[ii][jj] = true;
              encolar.first.first = ii;
              encolar.first.second = jj;
              encolar.second = posicion;
      ...
      while (not cola.empty()) {
          ...
          for (int k = 0; k < 4; ++k) {
              ...
              if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
                  ...
                  if (casilla.id == mi_mama.id) return p;
                  encolar.first.first = ii;
                  encolar.first.second = jj;
                  encolar.second = p;
                  cola.push(encolar);
  ...
  void bfs_trabajadoras (int id_worker, vector<vector<int>>& huecos_ocupados) {
    ...
    //LA REINA ESTA CERCA
      ...
      Pos pos_mama = buscar_mama(my_worker, mi_mama);
      ...
      if (my_worker.bonus == None and my_worker.life > 1) {
        ...
        if(move_a_favor(my_worker, pos_mama, huecos_ocupados)) return;
     }
     //BUSCAR A LA REINA
   if (my_worker.bonus != None) {
  ...
  Pos buscar_comida (Ant my_worker) {
      ...
      for (int k = 0; k < 4; ++k) {
          ...
          if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
              ...
              if (casilla.id != -1) {
                      ...
                      if (mi_hormiga.player == me() and mi_hormiga.bonus != None) return posicion;
              }
              visitados[ii][jj] = true;
              encolar.first.first = ii;
              encolar.first.second = jj;
          ...
          for (int k = 0; k < 4; ++k) {
              ...
              if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
                  ...
                  if (casilla.id != -1) {
                      ...
                      Ant mi_hormiga = ant (casilla.id);
                      if (mi_hormiga.player == me() and mi_hormiga.bonus != None) return p;
                  }
                  encolar.first.first = ii;
                  encolar.first.second = jj;
                  encolar.second = p;
     ...
     if (round() > 24) {
        ...
        if (mis_soldados.size() < 3 and carbohidratos >= soldier_carbo() and proteinas >= soldier_prote() and lipidos >= soldier_lipid()) {
            ...
            Cell huevo;
                  ...
                  if (huevo.id == -1 and huevo.type == Soil and my_queen.pos.i -1 >= 0 and my_queen.pos.i -1 < board_rows() and my_queen.pos.j >= 0 and my_queen.pos.j < board_cols()) {
                  ...
                  if (huevo.id == -1 and huevo.type == Soil and my_queen.pos.i >= 0 and my_queen.pos.i < board_rows() and my_queen.pos.j -1 >= 0 and my_queen.pos.j -1 < board_cols()) {
  ...
  Pos buscar_hormiga (Ant my_worker) {
      ...
      for (int k = 0; k < 4; ++k) {
          ...
          if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
              ...
              if (casilla.id != -1) {
                      ...
                      Ant mi_hormiga = ant (casilla.id);
                      if (mi_hormiga.player != me() and mi_hormiga.type == Worker) return posicion;
              }
              visitados[ii][jj] = true;
              encolar.first.first = ii;
              encolar.first.second = jj;
          ...
          for (int k = 0; k < 4; ++k) {
              ...
              if (ii >= 0 and ii < n and jj >= 0 and jj < m and visitados[ii][jj] == false and casilla.type == Soil) {
                  ...
                  if (casilla.id != -1) {
                      ...
                      Ant mi_hormiga = ant (casilla.id);
                      if (mi_hormiga.player != me() and mi_hormiga.type == Worker) return p;
                  }
                  encolar.first.first = ii;
                  encolar.first.second = jj;
                  encolar.second = p;
